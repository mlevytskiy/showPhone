...
public class CircleLayout extends ViewGroup {
    ...
    public CircleLayout(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            if(mInnerCircle instanceof ColorDrawable) {
                int innerColor = a.getColor(R.styleable.CircleLayout_innerCircle,
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for(int i=0; i<childs; i++) {
            ...
            final int left = (lp.width != LayoutParams.FILL_PARENT ? x - halfChildWidth : 0) + 70;
            final int top = (lp.height != LayoutParams.FILL_PARENT ? y - halfChildHeight : 0) - 50;
            final int right = (lp.width != LayoutParams.FILL_PARENT ? x + halfChildWidth : width) + 70;
            final int bottom = (lp.height != LayoutParams.FILL_PARENT ? y + halfChildHeight : height) - 50;
